...
internal static class HtmlTemplate
{
    private static readonly string Script = """
        <script>
            ...
            var resizeW = null;
            resizer.addEventListener('contextmenu', function(e) { e.preventDefault(); });
            ...
            function onResize(e) {
              resizeW = Math.max(160, Math.min(600, e.clientX)) + 'px';
              document.documentElement.style.setProperty('--sidebar-w', resizeW);
            }
            function onTouchResize(e) {
              e.preventDefault();
              resizeW = Math.max(160, Math.min(600, e.touches[0].clientX)) + 'px';
              document.documentElement.style.setProperty('--sidebar-w', resizeW);
            }
            function stopResize() {
              document.removeEventListener('mousemove', onResize);
              document.removeEventListener('mouseup', stopResize);
              if (resizeW) localStorage.setItem('sidebar-w', resizeW);
            }
    ...
    public static string Render(
        ...
        <head>
          ...
          <script>var _sw=localStorage.getItem('sidebar-w');if(_sw)document.documentElement.style.setProperty('--sidebar-w',_sw);</script>
        </head>
        <body>
    ...
    public const string Css = """
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        details[open] > summary.nav-section::before { transform: rotate(90deg); }

        summary.nav-subsection {
        ...
        details[open] > summary.nav-subsection::before { transform: rotate(90deg); }

        summary.nav-section:hover,
        summary.nav-subsection:hover { color: #ffffff; }
        ...
        @media (hover: hover) {
          #sidebar-resizer:hover { background: #007acc; }
        }

        @media (pointer: coarse) {
          #sidebar-resizer { width: 16px; margin-left: -6px; }
        }
